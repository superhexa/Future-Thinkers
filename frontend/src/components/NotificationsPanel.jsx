...
export function NotificationsPanel({ onClose }) {
  ...
  return (
    <>
      ...
      <div className="absolute left-0 right-auto mt-2 w-[min(360px,calc(100vw-1rem))] max-w-[calc(100vw-1rem)] bg-white rounded-2xl ft-shadow-lg border border-slate-200 z-50 overflow-hidden" data-testid="notifications-panel">
